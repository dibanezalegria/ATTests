...
import com.pbluedotsoft.atapp.databinding.FragmentNineHoleBinding;
 ...
 */
public class NineHoleFragment extends Fragment implements TextWatcher, AdapterView.OnItemSelectedListener {

    private static final String LOG_TAG = NineHoleFragment.class.getSimpleName();
    // Hand
    ...
    private FragmentNineHoleBinding bind;

    public NineHoleFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bind = DataBindingUtil.inflate(inflater, R.layout.fragment_nine_hole, container, false);
        ...
        // Spinner
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(getContext(), R.array.nine_gender_spinner,
